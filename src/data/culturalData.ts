...
category: 'Batik',
thumbnail: images.Dpringsedapur,
location: 'Magetan, Jawa Timur',
shortDesc: 'Batik Pring Sedapur merupakan batik khas Magetan dengan motif bambu yang melambangkan kesederhanaan, kebersamaan, dan keteguhan hidup masyarakat.',
fullDesc: 'Batik Pring Sedapur berasal dari Magetan, Jawa Timur, dan dikenal dengan motif utama berupa rumpun bambu atau “pring”. Istilah “sedapur” berarti satu rumpun, yang melambangkan kebersamaan, keharmonisan, dan persaudaraan antar manusia. Motif bambu pada batik ini menggambarkan filosofi kehidupan masyarakat Magetan yang sederhana, kuat, dan saling mendukung. Warna yang digunakan umumnya lembut dan alami, seperti hijau, coklat, dan krem, yang mencerminkan kesejukan serta kedamaian alam pegunungan Magetan. Batik Pring Sedapur tidak hanya menjadi simbol identitas daerah, tetapi juga cerminan karakter masyarakatnya yang ramah dan menjunjung tinggi nilai gotong royong.',
highlights: [
  'Motif bambu (“pring”) sebagai simbol kebersamaan dan keharmonisan',
  'Berasal dari Magetan, Jawa Timur, daerah yang dikenal dengan keindahan alamnya',
  'Warna lembut dan alami mencerminkan kesejukan pegunungan',
  'Simbol identitas budaya dan filosofi hidup masyarakat Magetan'
],
gallery: [images.Dpringsedapur],
funFacts: [
  'Nama “Pring Sedapur” berarti rumpun bambu yang tumbuh bersama, melambangkan persatuan dan kerja sama.',
  'Motif bambu sering dikombinasikan dengan unsur alam seperti burung dan dedaunan.',
  'Batik Pring Sedapur menjadi ikon resmi Kabupaten Magetan dan sering dipakai dalam acara adat dan pemerintahan.'
],
culturalSignificance: 'Melambangkan filosofi kebersamaan, kesederhanaan, dan keteguhan masyarakat Magetan. Batik Pring Sedapur menjadi simbol identitas lokal sekaligus warisan budaya yang memperkuat jati diri daerah.',
relatedLinks: ['Magetan', 'Motif Pring Sedapur', 'Batik Pegunungan', 'Filosofi Bambu'],
...
category: 'Batik',
thumbnail: images.Dgentongan,
location: 'Pamekasan, Madura, Jawa Timur',
shortDesc: 'Batik Gentongan adalah batik khas Madura yang dibuat dengan teknik pewarnaan alami menggunakan gentong tanah liat, menghasilkan warna tajam dan berlapis.',
fullDesc: 'Batik Gentongan merupakan batik khas Pamekasan, Madura, yang memiliki proses pembuatan unik dan memakan waktu lama karena menggunakan gentong tanah liat sebagai wadah pewarnaan. Kata “gentongan” sendiri berasal dari kata “gentong” — wadah dari tanah liat tempat kain direndam dalam pewarna alami selama berminggu-minggu hingga warnanya benar-benar meresap. Proses ini menghasilkan warna-warna yang tajam, dalam, dan tahan lama, seperti merah marun, ungu, dan coklat tua. Motif Batik Gentongan biasanya menampilkan pola flora, fauna, serta ornamen tradisional Madura yang berani dan kontras. Setiap lembar batik dibuat secara manual dan dianggap sebagai karya seni bernilai tinggi karena tingkat kesulitannya yang tinggi.',
highlights: [
  'Menggunakan gentong tanah liat untuk proses pewarnaan alami',
  'Warna tajam, berlapis, dan tahan lama (merah marun, ungu, coklat tua)',
  'Motif berani khas Madura dengan elemen flora dan fauna',
  'Proses pembuatan memakan waktu berminggu-minggu hingga berbulan-bulan'
],
gallery: [images.Dgentongan],
funFacts: [
  'Proses pewarnaan Batik Gentongan bisa memakan waktu hingga tiga bulan agar warna benar-benar meresap.',
...
title: 'Yadnya Kasada',
category: 'Tradisi',
thumbnail: images.Eyadnya,
location: 'Gunung Bromo, Probolinggo (Suku Tengger, Jawa Timur)',
schedule: 'Bulan Kasada (kalender Tengger, sekitar Juni–Juli)',
shortDesc: 'Upacara adat suku Tengger untuk mempersembahkan hasil bumi kepada Sang Hyang Widhi di kawah Gunung Bromo sebagai wujud syukur dan permohonan berkah.',
fullDesc: 'Yadnya Kasada adalah upacara suci masyarakat Suku Tengger yang dilaksanakan setiap bulan Kasada, tepatnya pada malam bulan purnama di kaki Gunung Bromo. Tradisi ini merupakan bentuk persembahan dan ungkapan syukur kepada Sang Hyang Widhi atas rezeki dan keselamatan yang diberikan. Dalam ritual ini, masyarakat Tengger membawa berbagai hasil bumi, ternak, dan sesaji lain ke kawah Gunung Bromo untuk dipersembahkan. Upacara dimulai dengan doa dan prosesi adat di Pura Luhur Poten, dilanjutkan dengan arak-arakan menuju kawah. Bagi masyarakat Tengger, Yadnya Kasada tidak hanya bermakna spiritual, tetapi juga simbol pengabdian, rasa syukur, dan pelestarian warisan leluhur yang telah turun-temurun. Tradisi ini menjadi daya tarik budaya dan wisata spiritual yang unik di Jawa Timur.',
highlights: [
  'Ritual persembahan hasil bumi ke kawah Gunung Bromo',
  'Dilaksanakan setiap bulan Kasada (kalender Tengger)',
  'Dimulai dari Pura Luhur Poten dengan doa dan arak-arakan',
  'Menjadi simbol syukur, pengabdian, dan pelestarian budaya Suku Tengger'
],
gallery: [images.Eyadnya],
funFacts: [
  'Yadnya berarti “persembahan suci”, sedangkan Kasada adalah nama bulan dalam kalender Tengger.',
  'Masyarakat Tengger percaya bahwa sesaji yang dilempar ke kawah akan membawa berkah dan kesejahteraan.',
  'Ada kisah legenda Roro Anteng dan Joko Seger yang menjadi asal mula tradisi ini.'
],
culturalSignificance: 'Simbol rasa syukur dan pengabdian masyarakat Tengger kepada Sang Hyang Widhi; menjaga harmoni antara manusia, alam, dan Tuhan; sekaligus pelestarian identitas budaya spiritual di kawasan Bromo.',
relatedLinks: ['Pura Luhur Poten', 'Suku Tengger', 'Gunung Bromo', 'Legenda Roro Anteng dan Joko Seger']
  },
  {
    id: 'tradisi-2',
    title: 'Kebo-keboan',
...
title: 'Keduk Beji',
category: 'Tradisi',
thumbnail: images.Ekedukbeji,
location: 'Malang dan sekitarnya',
schedule: 'Sekitar bulan Suro (penanggalan Jawa)',
shortDesc: 'Upacara adat pembersihan sumber mata air sebagai wujud rasa syukur dan doa agar air tetap melimpah dan membawa berkah bagi masyarakat.',
fullDesc: 'Keduk Beji adalah tradisi adat masyarakat Jawa Timur, terutama di wilayah Malang dan sekitarnya, yang bertujuan untuk membersihkan sumber mata air atau “beji”. Upacara ini dilaksanakan sebagai bentuk ungkapan syukur kepada Tuhan atas limpahan air yang menjadi sumber kehidupan, sekaligus memohon agar air tetap bersih, melimpah, dan membawa kesejahteraan. Prosesi Keduk Beji biasanya diawali dengan doa bersama dan selamatan, kemudian masyarakat bergotong-royong membersihkan area sumber air dari kotoran dan lumut. Acara dilanjutkan dengan hiburan rakyat seperti jaranan, wayang, atau tumpengan. Tradisi ini mencerminkan kepedulian terhadap lingkungan serta semangat kebersamaan masyarakat agraris yang menggantungkan hidupnya pada air.',
highlights: [
  'Ritual pembersihan sumber mata air (beji)',
  'Doa bersama dan selamatan sebagai ungkapan syukur',
  'Gotong royong membersihkan area sumber air',
  'Dimeriahkan hiburan rakyat seperti jaranan dan tumpengan'
],
gallery: [images.Ekedukbeji],
funFacts: [
  'Kata “Keduk Beji” berarti “menggali atau membersihkan sumber air”.',
  'Tradisi ini mencerminkan filosofi keseimbangan antara manusia dan alam.',
  'Sering diadakan di bulan Suro karena dianggap waktu yang sakral untuk pembersihan diri dan lingkungan.'
],
culturalSignificance: 'Melambangkan rasa syukur atas anugerah alam, khususnya air; mempererat solidaritas sosial melalui gotong royong; serta menegaskan pentingnya menjaga kelestarian lingkungan.',
relatedLinks: ['Gotong Royong', 'Selamatan', 'Jaranan', 'Pelestarian Alam'],
  },
  {
    id: 'tradisi-4',
title: 'Larung Sembonyo',
category: 'Tradisi',
thumbnail: images.Elarung,
location: 'Pantai Prigi, Trenggalek',
schedule: 'Setelah musim panen ikan (sekitar bulan Selo – Dzulqaidah)',
shortDesc: 'Upacara adat masyarakat pesisir Trenggalek untuk melarung sesaji ke laut sebagai ungkapan syukur atas hasil laut dan doa keselamatan nelayan.',
fullDesc: 'Larung Sembonyo adalah tradisi adat yang dilaksanakan oleh masyarakat pesisir Trenggalek, khususnya di kawasan Pantai Prigi. Upacara ini merupakan bentuk ungkapan syukur kepada Tuhan atas limpahan hasil laut sekaligus permohonan keselamatan bagi para nelayan. Prosesi diawali dengan doa bersama dan arak-arakan sesaji yang berisi hasil bumi, kepala sapi, tumpeng, serta berbagai makanan tradisional. Sesaji tersebut kemudian dilarung atau dihanyutkan ke laut sebagai simbol persembahan kepada penguasa laut. Acara Larung Sembonyo biasanya diramaikan dengan hiburan rakyat, parade perahu hias, dan pertunjukan seni seperti jaranan, reog, dan tari tradisional. Tradisi ini tidak hanya sarat makna spiritual, tetapi juga memperkuat solidaritas sosial masyarakat nelayan dan menjadi daya tarik wisata budaya di Trenggalek.',
highlights: [
  'Ritual melarung sesaji ke laut sebagai ungkapan syukur',
  'Prosesi arak-arakan sesaji dari darat menuju pantai',
  'Diramaikan parade perahu hias dan pertunjukan seni rakyat',
  'Simbol doa keselamatan dan kesejahteraan bagi para nelayan'
],
gallery: [images.Elarung],
funFacts: [
  'Nama “Sembonyo” berasal dari kata “sembah” yang berarti persembahan kepada Tuhan.',
  'Larung Sembonyo sudah berlangsung turun-temurun sejak masa kerajaan di pesisir selatan Jawa.',
  'Tradisi ini juga menjadi momen silaturahmi besar bagi warga pesisir dan nelayan dari berbagai daerah.'
],
culturalSignificance: 'Simbol rasa syukur atas hasil laut, doa keselamatan bagi nelayan, serta sarana mempererat solidaritas masyarakat pesisir dan menjaga hubungan harmonis dengan alam laut.',
relatedLinks: ['Pantai Prigi', 'Nelayan Trenggalek', 'Parade Perahu Hias', 'Budaya Pesisir Jawa Timur'],
  },
];
...
export const situsSejarahData: CulturalItem[] = [
  ...
  },
  {
    ...
    gallery: [images.Idejavaschebank],
