...
export const tarianData: CulturalItem[] = [
  ...
  gallery: [images.Gjawa, images.Handeandelumut, IMAGE_PLACEHOLDERS.GENERAL_CULTURE],
...
export const batikData: CulturalItem[] = [
  ...
  gallery: [images.Gmadura, IMAGE_PLACEHOLDERS.GENERAL_CULTURE],
  ...
  gallery: [images.Ipenataran, IMAGE_PLACEHOLDERS.HISTORY],
